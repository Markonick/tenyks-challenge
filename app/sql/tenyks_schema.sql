...
CREATE TABLE IF NOT EXISTS tenyks.image_category(
    ...
    PRIMARY KEY (id),
    CONSTRAINT fk_tenyks_image_category_image FOREIGN KEY (image_id) REFERENCES tenyks.image(id)
);

-- CREATE TABLE IF NOT EXISTS tenyks.model_image_output(
--     image_id INT NOT NULL,
--     model_id INT NOT NULL,
--     PRIMARY KEY (image_id, model_id),
--     CONSTRAINT fk_tenyks_model_image_output_image FOREIGN KEY (image_id) REFERENCES tenyks.image(id),
--     CONSTRAINT fk_tenyks_model_image_output_model FOREIGN KEY (model_id) REFERENCES tenyks.model(id)
-- );
...
--     CONSTRAINT fk_tenyks_model_image_bbox_model FOREIGN KEY (model_id) REFERENCES tenyks.model(id)
-- );
...
--     value JSON NOT NULL,
--     PRIMARY KEY (image_id, model_id),
--     CONSTRAINT fk_tenyks_model_image_category_image FOREIGN KEY (image_id) REFERENCES tenyks.image(id),
--     CONSTRAINT fk_tenyks_model_image_category_model FOREIGN KEY (model_id) REFERENCES tenyks.model(id)
-- );
